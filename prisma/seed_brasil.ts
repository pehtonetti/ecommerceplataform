...
const main = async () => {
    ...
    const products = [
        ...
        { name: 'Caixa JBL Charge 5 Bluetooth IP67 Militar', price: 89900, cat: 'Áudio & Fones', img: 'https://images.unsplash.com/photo-1545454675-3531bfa9925d?q=80&w=800', desc: 'Powerbank integrado, 20 horas de reprodução e à prova de mergulhos.' },
        ...
        { name: 'Instax Mini 12 Lila Candy - Câmera Fujifilm', price: 45900, cat: 'Acessórios Tech', img: 'https://images.unsplash.com/photo-1526170315873-3a98ce503a23?q=80&w=800', desc: 'Exposição automática e espelho de selfie integrado para fotos instantâneas.' },
        ...
        { name: 'Cartão de Memória SanDisk 128GB MicroSDXC Switch', price: 12900, cat: 'Acessórios Tech', img: 'https://images.unsplash.com/photo-1597731908075-812e9b08f426?q=80&w=800', desc: 'Otimizado para Nintendo Switch com velocidades de leitura ultra-rápidas.' },
        ...
        { name: 'Power Bank Anker 10000mAh 22.5W Fast Charge', price: 21900, cat: 'Acessórios Tech', img: 'https://images.unsplash.com/photo-1609091839311-d536819bc248?q=80&w=800', desc: 'A marca número 1 em tecnologia de carregamento no mundo. Compacto e potente.' },
